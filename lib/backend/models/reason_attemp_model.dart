class AttempReason {
  ...
  AttempReason({this.success, this.data});

  AttempReason.fromJson(Map<String, dynamic> json) {
...
class Data {
  String? status;
  // List<DeliveryAttempts>? deliveryAttempts;
  List<AttemptReasons>? attemptReasons;
  // List<Null>? pickupAttempts;
  List<PickupAttemptReasons>? pickupAttemptReasons;
  // OrderInfo? orderInfo;
  ...
  Data({
    ...
    this.attemptReasons,
    // this.pickupAttempts,
    this.pickupAttemptReasons,
    // this.orderInfo
  });

  Data.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    // if (json['deliveryAttempts'] != null) {
    //   deliveryAttempts = <DeliveryAttempts>[];
    //   json['deliveryAttempts'].forEach((v) {
    //     deliveryAttempts!.add(new DeliveryAttempts.fromJson(v));
    //   });
    // }
    if (json['attempt_reasons'] != null) {
      attemptReasons = <AttemptReasons>[];
      json['attempt_reasons'].forEach((v) {
        attemptReasons!.add(AttemptReasons.fromJson(v));
      });
    }
    // if (json['pickupAttempts'] != null) {
    //   pickupAttempts = <Null>[];
    //   json['pickupAttempts'].forEach((v) {
    //     pickupAttempts!.add(new Null.fromJson(v));
    //   });
    // }
    if (json['pickup_attempt_reasons'] != null) {
      pickupAttemptReasons = <PickupAttemptReasons>[];
      json['pickup_attempt_reasons'].forEach((v) {
        pickupAttemptReasons!.add(PickupAttemptReasons.fromJson(v));
      });
    }
...
//   DeliveryAttempts({this.attemptedOn, this.attemptReason});
//   DeliveryAttempts.fromJson(Map<String, dynamic> json) {
//     attemptedOn = json['attempted_on'];
//     attemptReason = json['attempt_reason'];
//   }
//   Map<String, dynamic> toJson() {
//     final Map<String, dynamic> data = new Map<String, dynamic>();
//     data['attempted_on'] = this.attemptedOn;
//     data['attempt_reason'] = this.attemptReason;
//     return data;
//   }
// }

class AttemptReasons {
  String? code;
  String? value;

  AttemptReasons({this.code, this.value});

  AttemptReasons.fromJson(Map<String, dynamic> json) {
    code = json['code'];
    value = json['value'];
  }
}

class PickupAttemptReasons {
  String? code;
  String? value;

  PickupAttemptReasons({this.code, this.value});

  PickupAttemptReasons.fromJson(Map<String, dynamic> json) {
    code = json['code'];
    value = json['value'];
  }
}
